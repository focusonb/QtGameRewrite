...
int main(int argc, char* argv[])
{
	...
	//QObject::connect(&game_sub_window, SIGNAL(sendAChessData(std::string)), &socketManager, SLOT(sendStrData(std::string)));
	//QObject::connect(&game_sub_window, SIGNAL(sendAChessData(std::string)), &game_sub_window, SLOT(test(std::string)));
